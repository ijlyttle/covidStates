...
================
Compiled at 2020-12-28 22:50:00 UTC
...
2.  With *this* file open in the RStudio IDE, create a new RMarkdown
    ...
    ``` yaml
    title: "00-import"
    date: "Compiled at 2020-12-28 22:50:00 UTC"
    ...
    You can make it private, to restrict who sees it, if need be. We are
    ...
    file name, you will need to change this as well.
    ...
    -   contins a file named what you claim it is named.
...
4.  Create and build `01-clean.Rmd`; the goal is to pare down the
    ...
    -   `02-analyze.Rmd`, where we put together our maps
        ...
        to compiled file).
    -   `99-publish.Rmd`, where we put together our maps
        ([link](https://github.com/ijlyttle/covidStates/blob/workflow-publish/workflow/99-publish.md)
        to compiled file).

    I use a `99-publish.Rmd` file in my own workflows to:
